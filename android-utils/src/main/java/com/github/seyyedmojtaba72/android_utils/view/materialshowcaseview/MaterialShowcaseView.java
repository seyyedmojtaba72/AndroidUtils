...
import com.github.seyyedmojtaba72.android_utils.view.materialshowcaseview.shape.CircleShape;
import com.github.seyyedmojtaba72.android_utils.view.materialshowcaseview.shape.NoShape;
import com.github.seyyedmojtaba72.android_utils.view.materialshowcaseview.shape.RectangleShape;
import com.github.seyyedmojtaba72.android_utils.view.materialshowcaseview.shape.Shape;
import com.github.seyyedmojtaba72.android_utils.view.materialshowcaseview.target.Target;
import com.github.seyyedmojtaba72.android_utils.view.materialshowcaseview.target.ViewTarget;
...
public class MaterialShowcaseView extends FrameLayout implements View.OnTouchListener, View.OnClickListener {
    ...
    private void init(Context context) {
        ...
        View contentView = rootLayout.findViewById(R.id.root_layout);
    ...
    private void applyLayoutParams() {
        ...
        if (mContentBox != null && mContentBox.getLayoutParams() != null) {
            LinearLayout.LayoutParams contentLP = (LinearLayout.LayoutParams) mContentBox.getLayoutParams();
    ...
    private void setTitleTextTypeface(Typeface textTypeface) {
        if (mTitleTextView != null) {
            mTitleTextView.setTypeface(textTypeface);
        }
    }
    ...
    private void setContentTextTypeface(Typeface textTypeface) {
        if (mContentTextView != null && textTypeface != null) {
            mContentTextView.setTypeface(textTypeface);
        }
    }
    ...
    private void setDismissTextTypeface(Typeface textTypeface) {
        if (mDismissButton != null && textTypeface != null) {
            mDismissButton.setTypeface(textTypeface);
        }
    }
    ...
    public void setConfig(ShowcaseConfig config) {
        ...
        setContentTextTypeface(config.getContentTextTypeface());
        setDismissTextColor(config.getDismissTextColor());
        setDismissTextTypeface(config.getDismissTextTypeface());
