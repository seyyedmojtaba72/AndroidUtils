...
public class ShowcaseConfig {
    ...
    private Typeface mContentTextTypeface, mDismissTextTypeface;
    ...
    public Typeface getContentTextTypeface() {
        return mContentTextTypeface;
    }

    public void setContentTextTypeface(Typeface mContentTextTypeface) {
        this.mContentTextTypeface = mContentTextTypeface;
    }
    ...
    public Typeface getDismissTextTypeface() {
        return mDismissTextTypeface;
    }

    public void setDismissTextTypeface(Typeface mDismissTextTypeface) {
        this.mDismissTextTypeface = mDismissTextTypeface;
    }
